...
- 每個 extracted fact 都必須包含 evidence。
- LLM output 必須通過 schema validation。
- Low-confidence extraction 必須標記為 `needs_review`。
...
- Postgres 用於 sources、entities、facts、evidence、reviews 與 job state
